...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'List a specific package based on their ID',
		}),
...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'List all packages with a specific status',
		}),
		(0, swagger_1.ApiParam)({
			name: 'status',
...
__decorate(
	[
		...
		openapi.ApiResponse({
			...
			type: require('./packages.module').PackagesModule,
		}),
...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'Update a specific package based on their ID',
		}),
		...
		__metadata('design:paramtypes', [
			String,
			update_package_dto_1.UpdatePackageDto,
		]),
		__metadata('design:returntype', Promise),
	],
	PackagesController.prototype,
