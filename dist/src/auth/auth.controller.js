...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'Authenticate and generate JWT for user login',
		}),
...
__decorate(
	[
		...
		openapi.ApiResponse({
			status: 201,
			type: require('../users/users.module').UsersModule,
		}),
		__param(0, (0, common_1.Body)()),
		__metadata('design:type', Function),
...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'Retrieve user information based on JWT token',
		}),
...
__decorate(
	[
		(0, swagger_1.ApiOperation)({
			description: 'Upload an image and get the S3 URL',
		}),
		(0, common_1.Post)('upload-image'),
		(0, common_1.UseInterceptors)(
			(0, platform_express_1.FileInterceptor)('image')
		),
		openapi.ApiResponse({ status: 201 }),
