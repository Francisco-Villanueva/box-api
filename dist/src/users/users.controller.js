...
let UsersController = class UsersController {
    ...
    async update(id, updateUserDto) {
        try {
            ...
            const { name, lastName, userName, email, password, role, status, packages, rejectedDeclarationTime, } = updateUserDto;
            if (!(name ||
                lastName ||
                userName ||
                email ||
                ...
                throw new common_1.BadRequestException('Key for update not found on UserDto');
            }
...
__decorate([
    ...
    openapi.ApiResponse({ status: common_1.HttpStatus.CREATED, type: require("./users.module").UsersModule }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: 'List all users with role Carrier' }),
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "findCarriers", null);
__decorate([
    (0, swagger_1.ApiOperation)({ description: 'List a specific user based on their ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID of the user', type: String }),
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK, type: Object }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ description: 'Update a specific user based on their ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'userId', description: 'ID of the user', type: String }),
    (0, common_1.Get)('/:userId/packages'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK, type: [require("../packages/schema/packages.schema").Package] }),
    __param(0, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getPackages", null);
__decorate([
    (0, swagger_1.ApiOperation)({
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK, type: require("./schema/users.schema").User }),
    __param(0, (0, common_1.Param)('userId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, add_package_dto_1.AddPackageDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "addPackage", null);
__decorate([
    (0, swagger_1.ApiOperation)({ description: 'Delete a specific user based on their ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID of the user', type: String }),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UsersController.prototype, "removePackage", null);
