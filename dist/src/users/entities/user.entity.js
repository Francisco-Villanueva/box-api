...
let UsersEntity = class UsersEntity {
    static _OPENAPI_METADATA_FACTORY() {
        return { _id: { required: true, type: () => String }, name: { required: true, type: () => String }, lastName: { required: true, type: () => String }, userName: { required: true, type: () => String }, email: { required: true, type: () => String }, username: { required: true, type: () => String }, password: { required: true, type: () => String }, role: { required: true, enum: require("../../constants/roles").ROLES }, rejectedDeclarationTime: { required: true, type: () => Date } };
    }
};
...
], UsersEntity.prototype, "_id", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
], UsersEntity.prototype, "rejectedDeclarationTime", void 0);
