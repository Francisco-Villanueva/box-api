...
export declare class UsersController {
		...
		Omit<
			import('mongoose').Document<
				...
				import('mongoose').Document<
					unknown,
					{},
					import('./schema/users.schema').User
				> &
					import('./schema/users.schema').User & {
	...
	getPackages(
		id: string
	): Promise<import('../packages/schema/packages.schema').Package[]>
	addPackage(
		userId: string,
		{ packageId }: AddPackageDto
	): Promise<import('./schema/users.schema').User>
